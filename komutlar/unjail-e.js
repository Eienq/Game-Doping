...
member.roles.add('770473551127248906')//Verilecek Erkek Rol
member.roles.add('770473550431518772')//Verilecek 2. Erkek Rol
member.roles.remove('770901723929378836')//Cezalı Rol
...
.setTimestamp()
client.channels.cache.get('775358713723748372').send(embed1)//Log Kanal İd
